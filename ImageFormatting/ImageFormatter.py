...
def resizeImage(img):
    img = resize_contain(img,[256,256])#resizes images to a width of 500 pixels whilst keeping aspect ratio - eases computing power for crop analysis
...
if __name__ == "__main__":
    ...
    pixel = list(reduced.getdata())
    pixel = np.reshape(pixel, (50,50,3))
